...
/**
 * HTMLエスケープユーティリティ（メールテンプレートでのXSS防止）
 */
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <p>この度は、UGSにお申し込みいただき、誠にありがとうございます。</p>
...
export async function sendSubscriptionCancelledEmail(data: SubscriptionCancelledEmailData) {
  const mailOptions = {
    from: `"UGS" <${process.env.SMTP_USER}>`,
    to: data.to,
    subject: 'UGS - サブスクリプションキャンセルのお知らせ',
    encoding: 'utf-8',
    html: `
      <!DOCTYPE html>
      <html>
