...
export async function POST(request: NextRequest) {
  try {
    ...
    const fileName = `business-card-designs/${timestamp}_${sanitizedFileName}`

    // Supabase Storageにアップロード
    const bucketName = 'profile-picture'

    console.log('Uploading business card design preview to bucket:', bucketName)
    ...
    console.error('Error uploading business card design preview:', error)
    return NextResponse.json(
