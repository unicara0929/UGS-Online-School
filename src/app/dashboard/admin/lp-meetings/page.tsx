...
import { LogOut, Calendar, Clock, Video, CheckCircle, XCircle, Loader2, Users, AlertCircle } from "lucide-react"
          ...
          <div className="px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              <div className="flex items-center">
                <h1 className="text-2xl font-bold text-slate-900">LP面談管理（管理者）</h1>
              </div>
