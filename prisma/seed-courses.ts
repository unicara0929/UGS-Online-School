...
const coursesData: CourseData[] = [
  ...
  // ========================================
  {
    ...
    order: 1,
    lessons: [
      { title: 'スタートアップ基礎ステップ1', description: 'スタートアップの第一歩', duration: 600, order: 1, videoUrl: PLACEHOLDER_VIMEO_URL },
      { title: 'スタートアップ基礎ステップ2', description: '事業計画の作成', duration: 600, order: 2, videoUrl: PLACEHOLDER_VIMEO_URL },
      { title: 'スタートアップ基礎ステップ3', description: '法務・手続き', duration: 600, order: 3, videoUrl: PLACEHOLDER_VIMEO_URL },
      { title: 'スタートアップ基礎ステップ4', description: 'マーケティング基礎', duration: 600, order: 4, videoUrl: PLACEHOLDER_VIMEO_URL },
      { title: 'スタートアップ基礎ステップ5', description: '資金調達', duration: 600, order: 5, videoUrl: PLACEHOLDER_VIMEO_URL },
      { title: 'スタートアップ基礎ステップ6', description: '顧客獲得の基本', duration: 600, order: 6, videoUrl: PLACEHOLDER_VIMEO_URL },
      { title: 'スタートアップ基礎ステップ7', description: '売上管理', duration: 600, order: 7, videoUrl: PLACEHOLDER_VIMEO_URL },
      { title: 'スタートアップ基礎ステップ8', description: '人材採用', duration: 600, order: 8, videoUrl: PLACEHOLDER_VIMEO_URL },
      { title: 'スタートアップ基礎ステップ9', description: '事業継続の考え方', duration: 600, order: 9, videoUrl: PLACEHOLDER_VIMEO_URL },
    ],
  },
  {
    title: 'スタートアップ支援 - 応用編',
    ...
    order: 2,
    lessons: [
      { title: 'スタートアップ応用ステップ1', description: 'スケールアップ戦略', duration: 600, order: 1, videoUrl: PLACEHOLDER_VIMEO_URL },
      { title: 'スタートアップ応用ステップ2', description: '事業再構築', duration: 600, order: 2, videoUrl: PLACEHOLDER_VIMEO_URL },
      { title: 'スタートアップ応用ステップ3', description: '組織マネジメント', duration: 600, order: 3, videoUrl: PLACEHOLDER_VIMEO_URL },
      { title: 'スタートアップ応用ステップ4', description: '資金調達（応用）', duration: 600, order: 4, videoUrl: PLACEHOLDER_VIMEO_URL },
